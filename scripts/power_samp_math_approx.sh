...
BLOCK_SIZE="32"
USE_JACKKNIFE="true"
APPROX_STOP_MODE="${APPROX_STOP_MODE:-eos}"
APPROX_BUDGET_STRATEGY="${APPROX_BUDGET_STRATEGY:-restart}"
APPROX_SELECTION_MODE="${APPROX_SELECTION_MODE:-weighted_vote}"
...
EXTRA_ARGS="${EXTRA_ARGS} --approx_stop_mode ${APPROX_STOP_MODE}"
EXTRA_ARGS="${EXTRA_ARGS} --approx_budget_strategy ${APPROX_BUDGET_STRATEGY}"
EXTRA_ARGS="${EXTRA_ARGS} --approx_selection_mode ${APPROX_SELECTION_MODE}"
if [[ -n "${MAX_SAMPLING_TOKENS}" ]]; then
  EXTRA_ARGS="${EXTRA_ARGS} --max_sampling_tokens ${MAX_SAMPLING_TOKENS}"
fi
...
echo "APPROX_STOP_MODE=${APPROX_STOP_MODE} APPROX_BUDGET_STRATEGY=${APPROX_BUDGET_STRATEGY} APPROX_SELECTION_MODE=${APPROX_SELECTION_MODE}"
