...
RESAMPLE_INTERVAL="${RESAMPLE_INTERVAL:-8}"
RESAMPLE_METHOD="${RESAMPLE_METHOD:-systematic}"
PROPOSAL_TEMPERATURE="${PROPOSAL_TEMPERATURE:-1.0}"
PROPOSAL_TOP_K="${PROPOSAL_TOP_K:-}"
PROPOSAL_TOP_P="${PROPOSAL_TOP_P:-1.0}"
MAX_LOGW_STEP="${MAX_LOGW_STEP:-50.0}"
STOP_ON_ALL_EOS="${STOP_ON_ALL_EOS:-true}"
...
echo "MODEL=${MODEL} TEMP=${TEMP} MAX_NEW_TOKENS=${MAX_NEW_TOKENS}"
