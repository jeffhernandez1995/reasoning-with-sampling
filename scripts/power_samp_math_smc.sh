...
SMC_STOP_MODE="${SMC_STOP_MODE:-eos}"
SMC_BUDGET_STRATEGY="${SMC_BUDGET_STRATEGY:-restart}"
SMC_SELECTION_MODE="${SMC_SELECTION_MODE:-weighted_vote}"
...
EXTRA_ARGS="${EXTRA_ARGS} --smc_stop_mode ${SMC_STOP_MODE}"
EXTRA_ARGS="${EXTRA_ARGS} --smc_budget_strategy ${SMC_BUDGET_STRATEGY}"
EXTRA_ARGS="${EXTRA_ARGS} --smc_selection_mode ${SMC_SELECTION_MODE}"
...
echo "SMC_STOP_MODE=${SMC_STOP_MODE} SMC_BUDGET_STRATEGY=${SMC_BUDGET_STRATEGY} SMC_SELECTION_MODE=${SMC_SELECTION_MODE}"
